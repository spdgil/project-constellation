...
export function OpportunityDetail({
  ...
  return (
    <div className="max-w-4xl" data-testid="opportunity-detail">
      ...
      <section className="mb-8" aria-labelledby="deals-heading">
        <h2
          id="deals-heading"
          className="font-heading text-lg font-normal leading-[1.4] text-[#2C2C2C] mb-3"
        >
      ...
      <section className="mb-8" aria-labelledby="readiness-heading">
        <h2
      ...
      <section className="mb-8" aria-labelledby="constraint-heading">
        <h2
      ...
      <section className="mb-8" aria-labelledby="replication-heading">
        <h2
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-heading text-sm font-normal leading-[1.4] text-[#2C2C2C] mb-2">
