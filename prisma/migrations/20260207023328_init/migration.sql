...
CREATE TABLE "deals" (
    ...
    "description" TEXT,
    "investment_value_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "investment_value_description" TEXT NOT NULL DEFAULT '',
    "economic_impact_amount" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "economic_impact_description" TEXT NOT NULL DEFAULT '',
    "economic_impact_jobs" INTEGER,
