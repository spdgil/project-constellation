...
async function run() {
  ...
  for (const s of strategies) {
    ...
    const stratData = {
      ...
      component1: ((s.components as Record<string, string> | undefined)?.["1"]) ?? "",
      component2: ((s.components as Record<string, string> | undefined)?.["2"]) ?? "",
      component3: ((s.components as Record<string, string> | undefined)?.["3"]) ?? "",
      component4: ((s.components as Record<string, string> | undefined)?.["4"]) ?? "",
      component5: ((s.components as Record<string, string> | undefined)?.["5"]) ?? "",
      component6: ((s.components as Record<string, string> | undefined)?.["6"]) ?? "",
